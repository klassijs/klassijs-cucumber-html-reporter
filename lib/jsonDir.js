...
export const collectJSONS = function (options) {
  const jsonOutput = [];
  ...
  function addTimestamp(featureItem) {
    if (
      featureItem['elements'] &&
      featureItem['elements'][0] &&
      featureItem['elements'][0]['steps'] &&
      featureItem['elements'][0]['steps'][0] &&
      featureItem['elements'][0]['steps'][0]['output'] &&
      featureItem['elements'][0]['steps'][0]['output'][0]
    ) {
